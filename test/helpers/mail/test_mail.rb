...
class TestMail < Minitest::Test
  ...
  def test_hello_world
    ...
    assert_equal(mail.to_json, JSON.parse('{"content":[{"type":"text/plain","value":"some text here"},{"type":"text/html","value":"<html><body>some text here</body></html>"}],"from":{"email":"dx@sendgrid.com"},"personalization":[{"to":[{"email":"elmer.thomas@sendgrid.com"}]}],"subject":"Hello World from the SendGrid Ruby Library"}'))
  end
